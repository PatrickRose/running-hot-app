 ...
 *
 * Consequences, Charge costs and Charge consequences are the game's card sheet
 * verbatim, down to its capitalisation, rather than tidied on the way in. The
 * list was transcribed by hand once and the tidying is where the slips hid: a
 * consequence narrowed to "during the breather step", a Wound added to a Charge
 * that prints none, Anzu's one line written out as three. Kept verbatim, the
 * next pass over the sheet is a diff rather than a reading, and what the
 * application shows a player is what the card in their hand says.
 *
 * Tests\Unit\ProtectionCardBlueprintTest pins the rows that pass corrected.
 */
    ...
    public static function defaults(): array
    {
        return [
            self::card(
                ...
                consequence: '2 Tags, End the Run',
            ),
            self::card(
                code: 'PE002',
            ...
            self::card(
                ...
                kind: ProtectionKind::Physical,
                challenge: 'Brute (6)',
                consequence: '1 Alert, 3 Wounds',
                chargeCost: 5,
                chargeConsequence: '2 Alerts, 5 Wounds',
            ),
            self::card(
                code: 'PR002',
                name: 'Nachtkrapp',
                ...
                chargeCost: 4,
                chargeConsequence: '2 Wounds, runners may not play additional cards',
            ),
            self::card(
                code: 'PR003',
                name: 'Brazen bull',
                kind: ProtectionKind::Physical,
                challenge: 'Brute (2)',
                consequence: '1 Wound, Retry, Runners may not escape',
            ),
            self::card(
                code: 'PR004',
                name: 'Tigris',
            ...
            self::card(
                ...
                consequence: 'Tigris and Keresh +x+1, where X is the difference between '
                    .'security and runner successes',
            ),
            self::card(
                code: 'PR007',
                name: 'Peryton',
            ...
            self::card(
                ...
                kind: ProtectionKind::Cyber,
                challenge: 'Brute (4)',
                consequence: '1 Wound, next protection card +1 strength',
                chargeCost: 3,
                chargeConsequence: 'Also, any runners leaving before the end take 1 Tag',
            ),
            self::card(
                code: 'PR016',
                name: 'Chichevache',
                ...
                consequence: 'That runner takes 1 Wound, 1 Tag and an additional Wound or Tag '
                    .'(runner\'s choice)',
                chargeCost: 7,
            ...
            self::card(
                ...
                kind: ProtectionKind::Cyber,
                challenge: 'Brute (5)',
                consequence: 'Run leader chooses: One runner takes End the Run (2) or all '
                    .'runners take 2 Wounds and 2 Tags',
                chargeCost: 5,
            ...
            self::card(
                ...
                kind: ProtectionKind::Cyber,
                challenge: 'Brute (3)',
                consequence: 'Runners do not see the consequence or challenge strength of the '
                    .'next protection card',
            ),
            self::card(
                code: 'PR021',
                name: 'Gullinkambi',
                kind: ProtectionKind::Cyber,
                challenge: 'Brute (3)',
                consequence: 'The next two protection cards have +2 strength',
            ),
            self::card(
                code: 'PR022',
            ...
            self::card(
                ...
                consequence: '1 Wound, Retry. If 3+ encounters, instead, End the Run and Wounds '
                    .'= to the Number of Hellhound encounters.',
            ),
            self::card(
                code: 'PR025',
                name: 'Cú-síth',
                kind: ProtectionKind::Physical,
                challenge: 'Brute (3)',
                consequence: '2 Tags. If 3 or more encounters, replace with End the Run and N '
                    .'Tags, where N is the number of Cú-síth encounters.',
            ),
            self::card(
                code: 'PR026',
                name: 'Echidna',
                kind: ProtectionKind::Cyber,
                challenge: 'Hack (3)',
                consequence: 'Trigger a Consequence for any Protection Card from this Facility '
            ...
            self::card(
                ...
                consequence: 'Take an in-use equipment card from a runner and bury it under '
                    .'this card. During Setup, security may take any of these cards.',
            ),
            self::card(
                code: 'PR031',
                name: 'Cat síth',
                ...
                consequence: '3 Alerts, 2 Wounds, Cross out a box. When all the boxes are '
                    .'checked, return this card to Control □ □ □ □ □ □ □ □ □',
            ),
            self::card(
                code: 'PR032',
                name: 'Cŵn Annwn',
            ...
            self::card(
                ...
                kind: ProtectionKind::Physical,
                challenge: 'Hack (5)',
                consequence: 'At the end of the run (after accessing, or after an unsuccessful '
                    .'run), 1 runner is reduced to 1 health',
            ),
            self::card(
                code: 'PR034',
                name: 'Nøkken',
                kind: ProtectionKind::Physical,
                challenge: 'Hack (4)',
                consequence: '1 Alert per runner. Retry',
                chargeCost: 4,
                chargeConsequence: '1 Alert per runner in the group. End the Run.',
            ),
            self::card(
                code: 'PR035',
                name: 'Fossegrim',
                kind: ProtectionKind::Cyber,
                challenge: 'Hack (7)',
                consequence: 'N tags, where N is equal to the number of runners in the group. '
                    .'Retry',
                chargeCost: 4,
                chargeConsequence: '1 Tag per runner in the Group. End the Run.',
            ),
            self::card(
                code: 'PR036',
                name: 'Skogsrå',
            ...
            self::card(
                ...
                kind: ProtectionKind::Cyber,
                challenge: 'Brute (6)',
                consequence: 'Runners move back N protection cards (decided by the Security '
            ...
            self::card(
                ...
                consequence: 'All runners bury an equipment card under this card, or take End '
                    .'the Run. If there are 5 buried cards, return it to Control. Security '
                    .'keeps the buried cards.',
                chargeCost: 10,
                chargeConsequence: 'Each runner loses one equipment. End the Run.',
            ),
            self::card(
                code: 'PR039',
                name: 'Bindy',
                ...
                consequence: 'Retry',
                chargeCost: 1,
                chargeConsequence: '1 Alert, 1 Retry',
            ),
            self::card(
                code: 'PR040',
                name: 'Tobius',
            ...
            self::card(
                ...
                chargeCost: 1,
                chargeConsequence: '2 Alerts, 1 Wound',
            ),
            self::card(
                code: 'PS004',
            ...
            self::card(
                ...
                kind: ProtectionKind::Physical,
                challenge: 'Hack (4)',
                consequence: '1 Alert, 1 Tag',
                chargeCost: 1,
                chargeConsequence: '2 Alerts, 1 Tag',
            ),
            self::card(
                code: 'PS008',
                name: 'Knockout gas',
            ...
            self::card(
                ...
                kind: ProtectionKind::Cyber,
                challenge: 'Hack (10)',
                consequence: 'Take all equipment cards from one runner (including those that '
                    .'are equipped). Return this card to Control',
            ),
            self::card(
                code: 'PX005',
                name: 'Jólakötturinn',
                kind: ProtectionKind::Cyber,
                challenge: 'Hack (5)',
                consequence: 'Any runners with no equipment take 5 wounds. If this happens, '
            ...
            self::card(
                ...
                consequence: 'N alerts, where N is equal to the number of runners in the group. '
                    .'1 wound',
            ),
            self::card(
                code: 'PX007',
            ...
            self::card(
                ...
                kind: ProtectionKind::Cyber,
                challenge: 'Hack (10)',
                consequence: 'N+1 tags, where N is equal to the differences in successes from '
                    .'Security and the Runners. Split these tags as you wish',
            ),
            self::card(
                code: 'PX010',
